...
- **[`cli/`](cli/)** — `@hervedarritchon/vaults` (npm). The renderer + deploy CLI. Reads your vault, renders to HTML, includes to a Cloudflare Pages project on your own account.

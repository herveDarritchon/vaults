...
## 3. Decoupling roles from passwords
...
## 5. Composing an adventure from other creators' content
...
## 6. One Foundry generation per vault
...
## 7. Consolidate the Foundry mapping
